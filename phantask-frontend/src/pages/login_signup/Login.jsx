...
const Login = () => {
    ...
    return (
        ...
        >
            <main
                className="bg-red-900 bg-opacity-30 w-full rounded-2xl p-4 sm:p-8 backdrop-blur-sm border border-red-600 border-opacity-50 flex shadow-lg flex-col lg:flex-row lg:min-h-[90vh] gap-4 xl:gap-12"
            >
                <section
                    className="hover:scale-105 transition-transform duration-300 w-full md:max-h-44 lg:max-h-full lg:w-[50%] rounded-2xl flex flex-col justify-center lg:items-end p-4 sm:p-6 text-[#FFEAEA]"
                    aria-labelledby="welcome-heading"
                >
                    <div className="flex flex-col md:flex-row items-center justify-center gap-1 lg:flex-col ">
                        <h1
                            id="welcome-heading"
                            className="text-4xl text-center font-extrabold p-1 md:pr-[2rem] lg:pr-0 whitespace-normal overflow-hidden md:border-r-4 lg:border-none font-sans max-w-full md:max-w-[60%] lg:max-w-full"
                ...
                <aside
                    className="hover:scale-105 transition-transform duration-300 w-full lg:w-[50%] rounded-2xl flex flex-col items-center justify-center lg:items-start p-4 sm:p-6 overflow-y-auto mt-4 lg:mt-0 lg:p-2 lg:ml-4 min-h-[200px] sm:min-h-[300px]"
